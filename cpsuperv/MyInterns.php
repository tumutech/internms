      ...
      <div class="row">
        ...
        <div class="col-md-3 vh-100 bg-dark gap-4 d-flex flex-column">
            <div class="d-flex justify-content-center">
              <i class="fa fa-person fa-8x " aria-hidden="true"></i>
            </div>
          ...
          <div class="col-md-7 mx-auto">
            <div class="row"><div class="h2">Interns</div></div>
            <div class="row">
            <?php
          if(isset($_GET['msg'])){
            $msg = $_GET['msg'];
                  ...
                  <tr>
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      ...
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<tr>
                        <td>' . $row["fname"] . ' </td><td>' . $row["lname"] . "</td><td>" . $row["Course"] . "</td>
                        <td>" . $row["company"] . "</td>
                        <td>  <a  href='Approve.php?id=".$row['regno']."'  class='btn mx-auto btn-primary'>Approve</a></td> 
