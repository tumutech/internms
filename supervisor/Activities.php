          ...
          <div class="col-md-7 mx-auto">
            <div class="row">
              <div class="d-flex justify-content-around" >
                <button class="btn btn-primary">DAILY LOGS</button>
                <button class="btn btn-primary">Weekly LOGS</button>
              </div>
              <div class="row">
                <table class="table text-white table-dark table-striped">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Daily Logs</th>
                      <th scope="col">Solution</th>
                      <th scope="col">Details</th>
                      <th scope="col">UN Sign state</th>
                      <th scope="col">CP Sign state</th>
                    ...
                    <tr>
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                          ...
                          echo "<tr><td>" . $row["internee_regno"] . "</td><td>" . $row["dateuploaded"] . "</td><td>" . $row["problem"] . " </td><td>" . $row["solution"] . "</td><td>"."<a href='Activity.php?id=$row[logId]' class='btn btn-primary'>View</a>"."</td><td>" . $row["unsignstate"] . "</td><td>" . $row["cpsignstate"] . "</td></tr>";
                        }
                      } else {
                        echo "0 results";
                      }
